...
keywords={xml, DOCTYPE, head,  body, html, return, this, target, \$}, 
...
hidden, nth, even, odd, css, remove, width, height, addClass, removeClass,
toggleClass, val, prepend,  , prependTo, append, appendTo, clone, remove,
insertBefore, insertAfter, after, before, bind, trigger, click, mousemove,
hover, focus, submit, change, scroll, resize, keypress, show, animate, ajax,
ajaxSetup, get, post, ajaxStart, ajaxStop, param, serialize, map, ajax}, 
