...
\begin{frame}[fragile]{Disección del Script} % (fold)
\begin{itemize}
    \item \textbf{Selector de Expresiones.}
...
\begin{frame}[fragile]{Disección del Script} % (fold)
\begin{itemize}
    \item \textbf{Métodos de recorrido DOM.}
