...
\subsection{La fábrica de funciones JQuery} % (fold)

\begin{frame}[fragile]{La fábrica de funciones JQuery} % (fold)
...
\begin{frame}[fragile]{Parámetros (primera versión)} % (fold)
