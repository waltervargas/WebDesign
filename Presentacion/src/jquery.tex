...
\begin{frame}[fragile]{Tiene Atributos: [@foo]} % (fold)
Todos los elementos que tienen el atributo foo.
\textbf{Ejemplo}
\begin{itemize}
...
\begin{frame}[fragile]{Valores de Atributos no iguales: [@foo!=bar]} % (fold)
Todos los elementos en los que el atributo foo no tiene exactamente el valor
bar.
\textbf{Ejemplo}
\begin{itemize}
